...
//     let results;
//     results = dishes.filter(function(dish){
//         console.log("el inside problemOne filter: ", dish)
...
//    let matchDishes = dishes.filter(dish => dish.cuisine === userinput);
//    return matchDishes
// }
...
//     let ingredient = prompt("Enter an ingredient:");
//     let results = dishes.filter(function(dish) {
...
//     let DishChoice = dishes.map(function(dish) {
